...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    booking_code: Schema.Attribute.UID<'name'>;
    booking_date: Schema.Attribute.Date;
    booking_end: Schema.Attribute.Time;
    booking_status: Schema.Attribute.Enumeration<
      ['waiting_approve', 'approved', 'reject', 'complete']
    >;
    booking_time: Schema.Attribute.Time;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    employee_avatar: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    employee_email: Schema.Attribute.Email;
    employee_name: Schema.Attribute.String;
    employee_phone: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    service_price: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    working_time: Schema.Attribute.Integer;
  };
}
